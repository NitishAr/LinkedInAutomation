...
public class TestBase {
	...
	public static void WaitForElementClicable(By by, long timeOutInSeconds) {
		logger.info("waiting for element visibilityOf..");
		try {
			WebDriverWait wait = new WebDriverWait(driver, timeOutInSeconds);
	...
	/*public boolean isElementDisplayedAndEnabled(By by, long waitTime){
		try{
			return waitForExpectedElement (by,waitTime).isDisPlayed()
		}*/
	//}
}
